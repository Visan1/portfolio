...
- Processed final data for use in major search engines (Bing, Google, Yahoo), enhancing user experiences and improving search engine performance
...
Analyzed and visualized over 4.5 million points of data from Cyclistic database, a bike-share company using R and Tableau which led to a summer marketing campaign aimed to convert at least 10% of current casual riders into annual members.
