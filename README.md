...
- Developed and evaluated diverse AI data across various industry domains & different types of data utilizing Excel
...
- Updated ongoing marketing promotional content daily to align with current sales from businesses
...
- Reduced tasks length from 1.5 hours to 20 minutes through data driven decision making with Excel analysis, an improvement in efficiency by over 75% and saving over $10,000 in weekly expenses
...
Analyzed the database of a sports clothing company and compared the pricing, reviews, descriptions, rating and web traffic for Nike and Adidas products using SQL to manipulate and clean data. The data was then analyzed to provide recommendations for marketing and sales teams to increase sales. 
