...
- Assessed e-commerce data from businesses such as UberEats, Reebok, Best Buy and more in the Canadian market, optimizing promotions based on these product trends and reducing campaign development time by up to 15%. 
...
- Processed and labeled data for use in major search engines (Bing, Google) to improve user experiences and search engine performance.
...
- Utilized data analysis and visualization tools (Excel, Power BI) to streamline quality assurance tasks, reducing analysis time from 1.5 hours to 20 minutes which resulted in weekly cost savings of $10,000.
...
-	**Demographics Most Affected:** The most affected age groups are 30-39, 20-29, and 40-49 years old. Additionally, in 2022, reported cases among females surpassed those of males by approximately 30,000.
...
Analyzed an Excel dataset from a Telecom company and visualized the data in PowerBI to determine the main factors for customers leaving. The dashboard showcases the current rate of customers leaving (churn rate) and what the reasons were in terms of competition, pricing, network reliability and more. 
